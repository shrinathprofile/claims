...
# --- Function to Load and Embed Handbook into ChromaDB ---
@st.cache_resource
def setup_vector_store(handbook_file, api_key):
    """Sets up the ChromaDB vector store with the uploaded insurance handbook."""
    ...
    st.info("Loading and embedding handbook into ChromaDB...")
    try:
        ...
        vectorstore.persist()
        st.success("Handbook loaded and embedded successfully into ChromaDB!")
...
st.caption("Automated Insurance Claim Processing using OpenRouter and ChromaDB")
